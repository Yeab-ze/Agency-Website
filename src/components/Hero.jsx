  ...
  return (
    ...
    <motion.div  
     initial={{ opacity: 0, y: 20 }}
      ...
      viewport={{once: true}}
       className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connetctions and turning big idea into interactive digital experiences.</motion.p>
