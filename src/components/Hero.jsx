...
const Hero = () => {
  return (
    ...
    <div className='inline-flex items-center gap-2 border border-grey-300 p-1.5 pr-4 rounded-full'>
      ...
      <p className='text-sm sm:text-lg font-medium text-grey-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Creating meaningful connetctions and turning big idea into interactive digital experiences.</p>
